...
#define CUSTOM_MACHINE_NAME "Versa3D by CreateAll"
...
#define HOTEND_OFFSET_X {0.0, 32.2} // (in mm) for each extruder, offset of the hotend on the X axis
...
//#define MESH_BED_LEVELING    // Enable mesh bed leveling.
  ...
  #define MESH_INSET 75        // Mesh inset margin on print area
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {48.14169,48.14169,400,97.1402}  // default steps per unit for Ultimaker
